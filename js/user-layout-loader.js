...
//             .then(html => {
//                 navbarPlaceholder.innerHTML = html;
//                 loadUserProfile(); // Load user's name and picture
//
//                 // --- NOTIFICATION LOGIC ---
//                 checkForNotifications(); // Check on page load
//                 setInterval(checkForNotifications, 60000); // Check every 60 seconds
//
...
// });
//
// function loadUserProfile() { /* ... your existing profile loading function ... */ }
//
// function checkForNotifications() {
//     const token = localStorage.getItem('authToken');
//     if (!token) return;
...
//         headers: { 'Authorization': 'Bearer ' + token }
//     }).then(() => {
//         setTimeout(checkForNotifications, 500); // Update the count after a short delay
//     });
// }
//
